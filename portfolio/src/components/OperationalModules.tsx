...
export function OperationalModules() {
  ...
  return (
    <section id="operational-modules" className="max-w-6xl mx-auto px-6 py-20 relative">
      {/* Section Header */}
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4 border-b-2 border-slate-950 pb-6">
        <div>
          <span className="font-handwriting text-2xl font-bold text-slate-800 block mb-1">
            capabilities &amp; toolkits ~
          </span>
          <h2 className="font-pixel text-5xl sm:text-7xl font-extrabold text-slate-950 tracking-tight leading-none uppercase">
            OPERATIONAL MODULES
          </h2>
        </div>
        <p className="text-slate-700 text-sm max-w-xs font-mono font-semibold">
          [ STACK // v4.8 ]
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          className="rounded-3xl p-8 bg-white border-2 border-slate-950 shadow-[4px_4px_0px_#000] transition-all hover:translate-x-0.5 hover:translate-y-0.5 flex flex-col justify-between group"
        >
          <div>
