...
export function PlaygroundSection() {
  return (
    <section id="playground" className="relative py-14 sm:py-16 px-6 max-w-6xl mx-auto overflow-hidden">
      ...
      <div className="text-center mb-10 relative z-10">
        ...
        <h2 className="font-pixel text-4xl sm:text-6xl font-extrabold tracking-wider text-neutral-950 uppercase leading-none">
      ...
      <div className="relative min-h-[560px] w-full border-2 border-dashed border-neutral-300/80 rounded-2xl p-6 sm:p-10 bg-white/40 backdrop-blur-xs flex flex-wrap items-center justify-around gap-8">
        
        {/* SURROUNDING STICKER BADGES (4 Outer Pins) */}
        
        {/* Top-Left Sticker: Lavender pill */}
        <div className="absolute top-4 left-4 sm:left-6 bg-[#EDE9FE] text-purple-950 font-mono text-xs font-bold px-3.5 py-1.5 rounded-full border border-purple-200/80 shadow-xs -rotate-3 z-30 flex items-center gap-1.5 select-none">
          <span>full-stack ready</span>
          <Sparkles className="w-3.5 h-3.5 text-purple-700" />
        </div>

        {/* Top-Right Sticker: Pastel mint pill */}
        <div className="absolute top-4 right-4 sm:right-6 bg-[#D1FAE5] text-emerald-950 font-mono text-xs font-bold px-3.5 py-1.5 rounded-full border border-emerald-200/80 shadow-xs rotate-2 z-30 flex items-center gap-1.5 select-none">
          <span>production grade</span>
          <Zap className="w-3.5 h-3.5 text-emerald-700" />
        </div>

        {/* Bottom-Left Sticker: Soft violet chip */}
        <div className="absolute bottom-4 left-4 sm:left-6 bg-[#F3E8FF] text-violet-950 font-mono text-xs font-bold px-3.5 py-1.5 rounded-full border border-violet-200/80 shadow-xs -rotate-2 z-30 flex items-center gap-1.5 select-none">
        ...
        <a
          href="#contact"
          className="absolute bottom-4 right-4 sm:right-6 bg-[#FEF3C7] text-amber-950 font-mono text-xs font-bold px-4 py-2 rounded-full border-2 border-black shadow-[3px_3px_0px_#000] rotate-3 hover:rotate-0 hover:scale-105 transition-all duration-300 z-30 flex items-center gap-1.5 cursor-pointer select-none"
        >
          <span>hire me</span>
        ...
        <div className="relative group cursor-pointer -rotate-2 hover:rotate-0 hover:-translate-y-2 transition-all duration-300 z-20">
          ...
          <div className="bg-white p-3.5 border-2 border-black shadow-[6px_6px_0px_#000] rounded-xl w-56 sm:w-64">
            ...
            <div className="mt-3">
              ...
              <p className="font-handwriting text-lg text-neutral-800 font-bold mt-1.5 flex items-center justify-start gap-1">
                <span>01 // modern web apps</span>
                <Rocket className="w-4 h-4 text-blue-600 inline" />
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative group cursor-pointer rotate-2 hover:rotate-0 hover:-translate-y-2 transition-all duration-300 z-10">
          ...
          <div className="bg-white p-3.5 border-2 border-black shadow-[6px_6px_0px_#000] rounded-xl w-56 sm:w-64">
            ...
            <div className="mt-3">
              ...
              <p className="font-handwriting text-lg text-neutral-800 font-bold mt-1.5 flex items-center justify-start gap-1">
                ...
                <Zap className="w-4 h-4 text-amber-500 fill-amber-400 inline" />
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative group cursor-pointer -rotate-1 hover:rotate-0 hover:-translate-y-2 transition-all duration-300 z-20">
          ...
          <div className="bg-white p-3.5 border-2 border-black shadow-[6px_6px_0px_#000] rounded-xl w-56 sm:w-64">
            ...
            <div className="mt-3">
              ...
              <p className="font-handwriting text-lg text-neutral-800 font-bold mt-1.5 flex items-center justify-start gap-1">
                ...
                <Database className="w-4 h-4 text-indigo-600 inline" />
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative group cursor-pointer rotate-3 hover:rotate-0 hover:-translate-y-2 transition-all duration-300 z-10">
          ...
          <div className="bg-white p-3.5 border-2 border-black shadow-[6px_6px_0px_#000] rounded-xl w-56 sm:w-64">
            ...
            <div className="mt-3">
              ...
              <p className="font-handwriting text-lg text-neutral-800 font-bold mt-1.5 flex items-center justify-start gap-1">
                ...
                <Cpu className="w-4 h-4 text-purple-600 inline" />
              </p>
            </div>
          </div>
        </div>
